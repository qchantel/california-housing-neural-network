...
[Here](https://www.kaggle.com/code/alisultanov/regression-xgboost-optuna) they achieve 0.84 R2 but I did not have time to dive in. Seems to remove (again) the outliers from both train AND test dataset. Which make this wrong. Unsure though.
